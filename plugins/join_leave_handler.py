...
class JoinLeaveHandler():
	...
	async def welcomeUser(self, server_id : str, member : str, server : str):
		welcome_enabled = ConfigLoader().load_server_config_setting(server_id, 'join_part', 'member_join_enabled')
	...
	async def goodbyeUser(self, server_id : str, member : str):
		part_enabled = ConfigLoader().load_server_config_setting(server_id, 'join_part', 'member_part_enabled')
