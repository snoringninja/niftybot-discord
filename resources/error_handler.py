...
from .error_logger import ErrorLogging
...
class CommandErrorHandler:
    ...
    async def on_command_error(self, ctx, error):
        ...
        print('Ignoring exception in command {}, in error_handler:'.format(ctx.command), file=sys.stderr)
        await ErrorLogging().log_error_without_await(
